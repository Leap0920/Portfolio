  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20 bg-slate-950">
      ...
      <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white mb-6 md:mb-8 leading-tight tracking-tighter animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          Carlo C. Baclao
        ...
        <p className="text-base sm:text-lg md:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed mb-8 md:mb-12 px-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          {INTRO_TEXT}
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 px-4 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          <a
            href="#projects"
            className="group relative w-full sm:w-auto px-8 py-4 bg-blue-600 text-white rounded-full font-bold overflow-hidden hover:bg-blue-700 transition-all hover:shadow-[0_0_20px_rgba(37,99,235,0.5)] text-center"
          >
          ...
          <a
            href="#contact"
            className="w-full sm:w-auto px-8 py-4 bg-slate-900 text-slate-300 border border-slate-800 rounded-full font-bold hover:border-slate-600 hover:text-white transition-all hover:shadow-lg text-center"
          >
            Contact Me
          </a>
        </div>
